...
export default async function handler(req, res) {
  ...
  try {
    await resend.emails.send({
      ...
      subject: `Hub Demo Request — ${name} / ${org}`,
      reply_to: email,
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:32px;">
          ...
          <table style="width:100%;border-collapse:collapse;">
            ...
            <tr>
              ...
              <td style="padding:12px 0;border-bottom:1px solid #eee;font-size:15px;color:#122012;">${org}</td>
            </tr>
            <tr>
              ...
              <td style="padding:12px 0;border-bottom:1px solid #eee;font-size:15px;color:#122012;"><a href="mailto:${email}" style="color:#256B42;">${email}</a></td>
            </tr>
            ${type ? `<tr>
              ...
              <td style="padding:12px 0;border-bottom:1px solid #eee;font-size:15px;color:#122012;">${type}</td>
            </tr>` : ''}
            ${message ? `<tr>
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:40px 32px;">
          <p style="font-size:17px;color:#122012;line-height:1.7;margin-bottom:20px;">Hi ${name.split(' ')[0]},</p>
          ...
          <p style="font-size:16px;color:#3A4E38;line-height:1.75;margin-bottom:20px;">The Hub packages assessments, courses, financial tools, and coaching resources into one licensed environment your members can access anytime. I look forward to showing you how it works for ${org}.</p>
