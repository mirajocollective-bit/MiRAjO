...
CREATE POLICY IF NOT EXISTS "Partners can read their invites"
...
CREATE POLICY IF NOT EXISTS "Partners can read each other's profile"
...
CREATE POLICY IF NOT EXISTS "Users can insert own completion"
  ON diagnostic_completion FOR INSERT
  WITH CHECK (auth.uid() = user_id);

CREATE POLICY IF NOT EXISTS "Partners can see completion for their couple"
...
CREATE POLICY IF NOT EXISTS "Partners can read their report"
...
CREATE POLICY IF NOT EXISTS "Users manage own diagnostic answers"
...
CREATE POLICY IF NOT EXISTS "Users manage own diagnostic notes"
